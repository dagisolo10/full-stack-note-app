    ...
    return (
        <div className="min-h-screen pb-6 sm:pb-8 sm:pt-12">
            <div className="max-w-4xl w-full mx-auto flex flex-col items-start px-4 sm:px-6 lg:px-8">
                ...
                {/* Form */}
                <form onSubmit={handleSubmit} className="bg-base-100/10 backdrop-blur-sm w-full flex flex-col gap-3 sm:gap-4 grow border border-primary-content/20 rounded-2xl p-4 sm:p-6 min-h-125 sm:min-h-150">
                    <input
