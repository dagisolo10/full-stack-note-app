...
const WelcomePage = () => {
    return (
        <div className="max-w-6xl mx-auto px-4 pb-10 text-center">
            <h1 className="xl:text-5xl md:text-4xl text-2xl font-bold text-gray-300">
                Welcome to <span className="">NoteBase</span>
            </h1>
            <h1 className="xl:text-8xl lg:text-7xl md:text-6xl text-4xl text-gray-400 font-extrabold tracking-tight py-4 text-gradient-muted">
                Unleash the power of<br></br> <span className="text-primary">intuitive thoughts</span>
            </h1>
            <p className="text-md md:text-xl text-gray-300">Organize your thoughts, ideas, and projects — all in one secure place.</p>
